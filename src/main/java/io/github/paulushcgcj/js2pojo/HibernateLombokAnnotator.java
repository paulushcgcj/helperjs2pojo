...
public class HibernateLombokAnnotator extends AbstractAnnotator {
  ...
  /**
   * Set all properties as private, and if found,
   * add the ID and GeneratedValue annotations to this ID.
   *
  ...
  /**
   * Add some of the Lombok annotations to the class along with Entity annotation,
   * and if not present, add an ID field.
   *
   * @param clazz        Class type.
   * @param propertyNode Node of property.
   */
